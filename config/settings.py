...
TEMPLATES = [
    {
        ...
        # Prioritaire sur les gabarits des applications : permet de
        # surcharger l'admin Django (templates/admin/base_site.html).
...
PRODUCT_BOT_SERPER_IMAGE_SEARCH_ENABLED = os.getenv(
    'PRODUCT_BOT_SERPER_IMAGE_SEARCH_ENABLED',
    'false',
).lower() in ('1', 'true', 'yes')
PRODUCT_BOT_SERPER_IMAGE_MAX_CREDITS = int(os.getenv('PRODUCT_BOT_SERPER_IMAGE_MAX_CREDITS', '4'))
PRODUCT_BOT_SERPER_IMAGE_NUM_MAX = int(os.getenv('PRODUCT_BOT_SERPER_IMAGE_NUM_MAX', '4'))
