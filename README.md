...
7. (Optionnel) En secours si Google ne renvoie rien: configure `SERPER_API_KEY` (et éventuellement `SERPER_ENDPOINT`), puis active `PRODUCT_BOT_SERPER_IMAGE_SEARCH_ENABLED=true`.
